...
{ //checker function for 2 coordinates
...
void printit()
{ //function for printing the possible arrangment
    cout << endl;
...
void solve(int col)
{
    ...
    for (int i = 0; i < n; i++)
    { //trying on different rows
 
        int ch = 1;
 
        for (int j = 0; j < col; j++)
        { //checking with previosly placed queens
        ...
        if (ch)
        { // if no problem with previously placed queens
